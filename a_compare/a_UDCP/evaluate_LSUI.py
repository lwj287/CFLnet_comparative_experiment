...
if __name__ == "__main__":
    ...
    parser.add_argument('--enhanced_dir', type=str, default="./a_compare/a_UDCP/enhs_LSUI")
    parser.add_argument('--output_dir', type=str, default="./a_compare/a_UDCP/vals_LSUI")
