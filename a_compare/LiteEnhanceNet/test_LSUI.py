...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_dir_raw', type=str, default="./a_LSUI/test_raw")
    parser.add_argument('--test_dir_GT', type=str, default="./a_LSUI/test_GT")
    parser.add_argument('--enhanced_images_dir', type=str, default="./a_compare/LiteEnhanceNet/enhs_LSUI")
    parser.add_argument('--trained_models_dir', type=str, default="./a_compare/LiteEnhanceNet/model_epoch_198_LSUI.ckpt")
