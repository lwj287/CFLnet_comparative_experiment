...
if __name__ == "__main__":
    ...
    parser.add_argument('--enhanced_images_dir', type=str, default="./a_compare/Shallow-UWnet/enhs_UIEB")
    parser.add_argument('--trained_models_dir', type=str, default="./a_compare/Shallow-UWnet/model_epoch_8_UIEB.ckpt")
