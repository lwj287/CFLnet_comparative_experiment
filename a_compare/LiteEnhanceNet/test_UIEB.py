...
def model_loader():
    trained_model = Mynet()
    trained_model = torch.load(config.trained_models_dir, weights_only=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_dir_raw', type=str, default="./a_UIEB/test_raw")
    parser.add_argument('--test_dir_GT', type=str, default="./a_UIEB/test_GT")
    parser.add_argument('--enhanced_images_dir', type=str, default="./a_compare/LiteEnhanceNet/enhs_UIEB")
    parser.add_argument('--trained_models_dir', type=str, default="./a_compare/LiteEnhanceNet/model_epoch_198_UIEB.ckpt")
