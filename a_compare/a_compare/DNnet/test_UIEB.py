...
if __name__ == "__main__":
    ...
    parser.add_argument('--enhanced_images_dir', type=str, default="./a_compare/DNnet/enhs_UIEB")
    parser.add_argument('--trained_models_dir', type=str, default="./a_compare/DNnet/checkpoint_UIEB.pth")
