...
if __name__ == "__main__":
    ...
    parser.add_argument('--enhanced_dir', type=str, default="./a_compare/a_IBLA/enhs_LSUI")
    parser.add_argument('--output_dir', type=str, default="./a_compare/a_IBLA/vals_LSUI")
