...
if __name__ == "__main__":
    ...
    parser.add_argument('--enhanced_images_dir', type=str, default="./a_compare/LiteEnhanceNet/enhs_EUVP")
    parser.add_argument('--trained_models_dir', type=str, default="./a_compare/LiteEnhanceNet/model_epoch_198_EUVP.ckpt")
