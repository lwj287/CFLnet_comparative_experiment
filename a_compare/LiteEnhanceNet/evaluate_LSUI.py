...
if __name__ == "__main__":
    ...
    parser.add_argument('--raw_dir', type=str, default="./a_LSUI/test_raw")
    parser.add_argument('--gt_dir', type=str, default="./a_LSUI/test_GT")
    parser.add_argument('--enhanced_dir', type=str, default="./a_compare/LiteEnhanceNet/enhs_LSUI")
    parser.add_argument('--output_dir', type=str, default="./a_compare/LiteEnhanceNet/vals_LSUI")
