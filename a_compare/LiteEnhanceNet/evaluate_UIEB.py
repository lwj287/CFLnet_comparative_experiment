...
if __name__ == "__main__":
    ...
    parser.add_argument('--raw_dir', type=str, default="./a_UIEB/test_raw")
    parser.add_argument('--gt_dir', type=str, default="./a_UIEB/test_GT")
    parser.add_argument('--enhanced_dir', type=str, default="./a_compare/LiteEnhanceNet/enhs_UIEB")
    parser.add_argument('--output_dir', type=str, default="./a_compare/LiteEnhanceNet/vals_UIEB")
