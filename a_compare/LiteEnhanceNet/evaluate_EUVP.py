...
if __name__ == "__main__":
    ...
    parser.add_argument('--enhanced_dir', type=str, default="./a_compare/LiteEnhanceNet/enhs_EUVP")
    parser.add_argument('--output_dir', type=str, default="./a_compare/LiteEnhanceNet/vals_EUVP")
