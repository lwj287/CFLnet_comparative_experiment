...
if __name__ == "__main__":
    ...
    parser.add_argument('--enhanced_dir', type=str, default="./a_compare/Shallow-UWnet/enhs_UIEB")
    parser.add_argument('--output_dir', type=str, default="./a_compare/Shallow-UWnet/vals_UIEB")
